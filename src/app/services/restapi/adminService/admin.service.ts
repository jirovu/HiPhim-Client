...
export class AdminService {
  ...
  public async getMovie(url: string): Promise<Movie> {
    return await this.http.get<Movie>(`http://localhost:1010/admin/personal${url}`).toPromise()
      .then(res => res)
      .catch(err => {
        throw err;
      });
  ...
  public async getAllNotApprovedMovies(): Promise<Array<Movie>> {
    return this.http.get<Array<Movie>>('http://localhost:1010/admin/getAllNotApprovedMovies').toPromise()
      .then(res => res)
      .catch(err => { throw err });
  }
  ...
  public async browseMovie(movie: Movie): Promise<Array<Movie>> {
    return await this.http.put<Array<Movie>>('http://localhost:1010/admin/browseMovie', movie).toPromise()
      .then(res => res)
      .catch(err => { throw err });
  }
  ...
  public async changePassForUser(user: User): Promise<boolean> {
    return await this.http.put<boolean>('http://localhost:1010/admin/changePassword', user).toPromise()
      .then(res => res)
      .catch(err => { throw err });
  }

  public async getAllLogs(): Promise<Array<Log>> {
    return await this.http.get<Array<Log>>('http://localhost:1010/admin/getAllLogs').toPromise()
      .then(res => res)
      .catch(err => { throw err });
  }
}
